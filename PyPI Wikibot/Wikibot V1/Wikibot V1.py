...
def chatbot():
  ...
  def get_response(user_input):
    ...
    responses = {
      ...
      "hello": "Hello there!",
      "hi": "Hi!",
      "how are you": "I am doing well, thanks for asking. How are you?",
  ...
  "good": "Great! I'm glad to hear that.\n how can I be of service?",
    ...
    try:
      ...
      for result in results:
          ...
          all_snippets += f"Result: \n\n**{wiki_page_title}**\n\n{cleaned_snippet}\n\n"

      return all_snippets

    except Exception as e:
      return "I couldn't find any information on Wikipedia. Could you rephrase your question?"
